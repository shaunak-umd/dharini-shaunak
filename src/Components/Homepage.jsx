    ...
    return(
        <div>
            ...
            <section className="flex flex-col items-center gap-14 bg-frame7 py-[290px]">
                ...
                <br></br><br></br>
                <div className="font-garamond text-md px-[10px] bg-theme-black text-white w-max">More details on <a href="https://github.com/shaunak-umd/dharini-shaunak/tree/main" target="_blank" className="cursor-fancy"><u>GitHub</u></a></div>
                <br></br><br></br>
